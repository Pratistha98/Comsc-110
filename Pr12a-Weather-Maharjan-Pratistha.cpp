...
void putData (int count, Weather w[])
{
  ...
  for (i = 0; i < count; i++)
  {
    cout << setw(9) << left  << w[i].loc;
    cout << setw(1) << left  << w[i].year;
    cout << setw(9) << right << w[i].mint;
    cout << setprecision (2);
    cout << setw(10) << right << w[i].rain;
    cout << setprecision (1);
    cout << setw(9) << right << w[i].temp << endl;
  }//End for
...
void putFoot(int count, Weather w[])
{
  ...
  cout <<"Total" << setw(9) << setprecision(2)<<
         totrain << setw(2)<< setprecision(1) << tottemp << endl;
